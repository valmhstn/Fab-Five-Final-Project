...
Evaluation Question: Which physiochemical factors are have the greatest impact on wine quality? 
                    (determining which features to use in the classification model)
...
Now that you know the type and number of independent and dependent variables, 
you are ready to use the analysis flow charts to choose your analysis!
